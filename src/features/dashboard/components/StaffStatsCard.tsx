...
export function StaffStatsCard({
  ...
  return (
    <div className="flex flex-col gap-4 h-full">
      ...
      <Link to="/leave-approval" className="block shrink-0">
        <div className="rounded-[12px] bg-white p-5 shadow-[0px_4px_20px_0px_#0000000D] hover:shadow-[0_8px_30px_rgba(108,93,211,0.12)] transition-all duration-200 border border-transparent flex flex-col h-full min-h-[135px]">
      ...
      {/* System Stats */}
      <div className="flex-1 rounded-[12px] bg-white p-6 shadow-[0px_4px_20px_0px_#0000000D] border border-transparent flex flex-col min-h-[145px] lg:min-h-0">
