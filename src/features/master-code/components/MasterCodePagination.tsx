    ...
    <div className="mt-4 flex items-center rounded-[6px] bg-white px-5 py-3 shadow-[0_2px_10px_rgba(16,24,40,0.08)]">
      <div className="ml-auto flex items-center gap-4">
        ...
        <div className="flex items-center gap-2 text-xs">
          <button
            type="button"
            className="inline-flex size-6 cursor-pointer items-center justify-center rounded border border-transparent text-[#8f93a1] hover:bg-[#f5f5f8] disabled:cursor-not-allowed disabled:opacity-40"
          ...
          {pages.map((page) => (
            <button
              key={page}
              type="button"
              className={`inline-flex size-7 cursor-pointer items-center justify-center rounded border text-xs ${
                page === currentPage
