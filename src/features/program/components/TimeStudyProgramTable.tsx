...
import { TimeStudyProgramCardView } from "./TimeStudyProgramCardView"
    ...
    return (
      <>
        <TimeStudyProgramCardView
          ...
          isLoading={isLoading}
          readonly={readonly}
          canAddTsProgram={canAddTsProgram}
          canUpdateTsProgram={canUpdateTsProgram}
          onEditRow={onEditRow}
          onAddSubProgramFromParent={onAddSubProgramFromParent}
          toggleExpand={(row) => {
                          ...
                          <TooltipTrigger asChild>
                            ...
                            >
                              ...
                              <span className="pointer-events-none absolute right-0 inline-flex flex-col items-center leading-none">
                                <ChevronUp
                                  className={`size-[10px] ${sortState.key === "code" && sortState.direction === "asc"
                                    ? "text-white"
                                    : "text-white/50"
                                  }`}
                                />
                                <ChevronDown
                                  className={`-mt-1 size-[10px] ${sortState.key === "code" && sortState.direction === "desc"
                                    ? "text-white"
                                    : "text-white/50"
                                  }`}
                                />
