...
export function DepartmentTable({
  ...
  return (
    <div className="flex flex-1 flex-col gap-[24px]">
      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between w-full min-w-0">
        ...
        <div className="grid grid-cols-3 gap-2 sm:gap-[12px] w-full lg:flex lg:w-auto lg:items-center lg:justify-end shrink-0">
          ...
          {!showHistory && (
            <button
              type="button"
              className="flex h-[48px] w-full lg:w-auto items-center justify-center gap-2 rounded-[10px] bg-[#6C5DD3] px-3 sm:px-4 text-white cursor-pointer"
              onClick={() => {
            ...
            >
              ...
              <span className="text-[13px] sm:text-[14px] font-medium text-white select-none whitespace-nowrap truncate">
                Inactive
              </span>
            </button>
          )}
          ...
          {!showHistory && canAddDepartment && (
            <Button
              onClick={onAdd}
              className="h-[48px] w-full lg:w-auto justify-center rounded-[10px] bg-[#6C5DD3] px-3 sm:px-4 text-[13px] sm:text-[14px] font-medium hover:bg-[#5B4DC5]"
            >
      ...
      {/* ── Desktop Table ─────────────────────────────────────────────────── */}
      {!showHistory && (
        <div className="hidden xl:block overflow-hidden rounded-[8px] border border-[#E5E7EB] bg-white">
