...
export function TransferPanel({
  ...
  return (
    <div className="flex flex-col overflow-hidden rounded-[8px] border border-[#E5E7EB] bg-white flex-1 min-w-0">
      ...
      {/* Scrollable List */}
      <ScrollArea className="h-[300px] py-1 px-1">
        {items.length > 0 ? (
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <button
                        ...
                        className={`flex w-full cursor-pointer items-center justify-between px-3 py-2 rounded-[6px] transition-colors text-left text-[12px] ${
