...
export function DepartmentAddPage({ id, onClose }: DepartmentAddPageProps) {
    ...
    const handleSettingsSave = async () => {
        ...
        const isSettingsValid = await trigger("settings")
        if (!isSettingsValid) {
            return
        }
        const values = getValues()
                                                        ...
                                                        <div key={setting.key} className="space-y-1">
                                                            <div className="flex items-center gap-3">
                                                                <Checkbox
                                                                    ...
                                                                    onCheckedChange={(val) => {
                                                                        ...
                                                                        if (setting.key === "apportioning") {
                                                                            if (isChecked) {
                                                                                ...
                                                                                setValue("settings.manualApportioning", false)
                                                                                setValue("settings.apportioningStartDate", null)
                                                                    ...
                                                                    className={`h-[18px] w-[18px] data-[state=checked]:bg-[#6C5DD3] data-[state=checked]:border-[#6C5DD3] disabled:opacity-50 ${((setting.key === "removeAutoFillEndTime" && settings.removeStartEndTime) ||
                                                                            (setting.key === "allowActivationStartDateAndEndDate" && !settings.allowMultiCodes))
                                                                            ? "cursor-not-allowed"
                                                                            : ""
                                                                        }`}
                                                                ...
                                                                <Label
                                                                    htmlFor={setting.key}
                                                                    className={`text-[14px] font-[400] text-[#374151] ${((setting.key === "removeAutoFillEndTime" && settings.removeStartEndTime) ||
                                                                            (setting.key === "allowActivationStartDateAndEndDate" && !settings.allowMultiCodes))
                                                                    ...
                                                                    >
                                                                        <div className="flex items-center gap-2">
                                                                            ...
                                                                            <Label
                                                                                ...
                                                                                className={`text-[14px] font-[400] text-[#374151] ${!settings.apportioning
                                                                         ...
                                                                         <div className="space-y-2 pt-2">
                                                                             <div className="grid grid-cols-2 gap-4 max-w-[400px]">
                                                                                 <div className="space-y-1.5">
                                                                                     <Label className="text-[13px] font-[500] text-[#374151]">Apportioning Start Date</Label>
                                                                                     <TitleCaseInput
                                                                                         type="date"
                                                                                         className="h-10 text-sm rounded-[6px] border-[#D1D5DB] bg-white px-3 w-full"
                                                                                 ...
                                                                                 <div className="space-y-1.5">
                                                                                     <Label className="text-[13px] font-[500] text-[#374151]">Apportioning End Date</Label>
                                                                                     <TitleCaseInput
                                                                                         type="date"
                                                                                         className="h-10 text-sm rounded-[6px] border-[#D1D5DB] bg-white px-3 w-full"
                                                                             ...
                                                                             {errors.settings?.apportioningEndDate && (
                                                                                 <p className="text-[12px] text-red-500">
                                                                                     {errors.settings.apportioningEndDate.message}
                                                                                 </p>
                                                                             )}
                                                                         </div>
                                                                     )}
