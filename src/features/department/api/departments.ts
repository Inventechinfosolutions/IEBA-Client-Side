...
function toDepartmentUI(dto: DepartmentResDto, options?: ToDepartmentUIOptions): Department {
  ...
  return {
    ...
    settings: {
      ...
      manualApportioning: dto.manualApportioning ?? false,
      ...
      removeDescriptionActivityNoteAnchor: dto.removeDescriptionActivityNoteAnchor ?? false,
      ...
      standByCostpool: dto.standByCostpool ?? false,
...
function toCreateUpdateDto(values: DepartmentUpsertValues): CreateDepartmentReqDto {
  ...
  return {
    ...
    removeDescriptionActivityNoteAnchor: values.settings.removeDescriptionActivityNoteAnchor,
    removeDescriptionActivityNoteMultiCode: values.settings.removeDescriptionActivityNoteMultiCode,
    allowActivationStartDateAndEndDate: values.settings.allowActivationStartDateAndEndDate,
    moveSaveSubmitToTop: values.settings.moveSaveSubmitToTop,
    standByCostpool: values.settings.standByCostpool,
