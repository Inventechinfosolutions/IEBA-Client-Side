...
export function MgtEmployeePanel({
  ...
  return (
    <TooltipProvider>
      <div className="flex w-full xl:w-[360px] xl:shrink-0 flex-col rounded-[6px] bg-white shadow-[0_4px_16px_rgba(16,24,40,0.12)] overflow-hidden">
        {/* Purple header */}
      ...
      <div className="overflow-y-auto divide-y divide-gray-200 h-[430px] sm:h-[330px] xl:h-[430px]">
        {isLoading ? (
