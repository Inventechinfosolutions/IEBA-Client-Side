...
const CALENDAR_MANAGEMENT_CLASS =
  "[&_.calendar-weeks-grid]:w-full [&_.calendar-weeks-grid]:![grid-template-columns:repeat(7,minmax(0,1fr))_minmax(0,1fr)_minmax(0,0.95fr)_minmax(0,1.15fr)] [&_.calendar-weeks-grid]:column-gap-3 [&_.calendar-weeks-grid]:row-gap-3 [&_.week-summary-header]:px-1 [&_.week-summary-header]:leading-tight [&_.week-summary-total]:px-1 [&_.week-summary-status]:px-1 [&_.week-summary-action]:px-1 [&_.day-cell]:size-7 sm:[&_.day-cell]:size-9 [&_.day-cell]:text-[9px] sm:[&_.day-cell]:text-[12px] [&_.week-summary-total]:min-h-9 [&_.week-summary-total]:text-[9px] sm:[&_.week-summary-total]:text-[12px] [&_.week-summary-status]:min-h-9 [&_.week-summary-action]:min-h-9 [&_.week-summary-action]:w-full"
